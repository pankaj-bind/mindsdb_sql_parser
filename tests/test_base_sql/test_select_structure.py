...
class TestSelectStructure:
    ...
    def test_select_identifier_with_dashes(self):
    ...
    def test_select_identifier_alias_complex(self):
    ...
    def test_select_from_aliased(self):
        ...
        for query in sql_queries:
            assert parse_sql(query) == expected_ast
    ...
    def test_select_where_constants(self):
    ...
    def test_select_from_where_elaborate_lowercase(self):
        ...
        assert str(parse_sql(sql)) == str(Select(targets=[Identifier(parts=["column1"]), Identifier(parts=["column2"])],
                                                   from_table=Identifier(parts=['t1']),
                                                   where=BinaryOperation(op="=",
                                                                         args=(Identifier(parts=['column1']), Constant(1))
                                                                         )))
    ...
    def test_select_limit_two_arguments(self):
    ...
    def test_select_limit_two_arguments_and_offset_error(self):
    ...
    def test_backticks_in_str(self):
    ...
    def test_tricky_tables_case(self):
    ...
    def test_double_aliased_table(self):
    ...
    def test_is_not_precedence(self):
