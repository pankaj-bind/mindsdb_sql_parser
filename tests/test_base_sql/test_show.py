...
from mindsdb_parser.ast.show import Show
...
class TestShow:
    ...
    def test_show_unknown_condition_error(self):
        sql = "SHOW databases WITH"
        with pytest.raises(ParsingException):
            parse_sql(sql)

    def test_show_tables_from_db(self):
    ...
    def test_show_function_status(self):
...
class TestShowNoSqlite:
    ...
    def test_common_like_where(self, cat):
    ...
    def test_common_like_where_from_in(self):
        categories = [
            'TABLE STATUS',
            'OPEN TABLES',
            'TRIGGERS',
    ...
    def test_common_like_where_from_in_modes(self):
        categories = [
            'TABLES',
        ]
        modes = [
    ...
    def test_common_like_double_where_from_in_modes(self):
        categories = [
            'COLUMNS',
            'FIELDS',
            'INDEX',
